...
export function applyThemeToDocument(theme: ThemeMode, skin: string, fontSize: string): void {
...
export function saveThemeToStorage(theme: ThemeMode, skin: string, fontSize: string): void {
