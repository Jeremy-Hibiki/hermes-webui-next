...
export function ComposerFooter({ onSend, busy, onCancel, onVoice, sendKey = 'enter' }: ComposerFooterProps) {
  ...
  return (
    ...
    >
      ...
      {pendingFiles.length > 0 && (
        <div className="flex gap-2 mb-2 flex-wrap">
          {pendingFiles.map((f, i) => {
            ...
            return (
              <span key={i} className="flex items-center gap-1 text-xs bg-[var(--surface)] px-2 py-1 rounded">
      ...
      <div className="flex items-end gap-2">
        ...
        {busy ? (
          <Button variant="ghost" size="icon" aria-label="Cancel" onClick={onCancel} className="text-[var(--error)]">
