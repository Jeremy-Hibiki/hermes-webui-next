...
describe("Type definitions", () => {
  ...
  it("ToolCall tracks status", () => {
    const tc: ToolCall = {
      ...
      status: "completed", result: "file contents",
    };
  ...
  it("CronJob has schedule and prompt", () => {
    const job: CronJob = {
      id: "j1", name: "Daily Report", schedule: "0 9 * * *",
      prompt: "Summarize today", session_id: "s1",
      enabled: true, paused: false, created_at: "",
    };
  ...
  it("AppSettings has theme and skin", () => {
    const settings: AppSettings = {
      theme: "dark", skin: "default", font_size: "default",
      default_model: null, default_provider: null,
      default_workspace: null, send_key: "enter",
      password_enabled: false, active_profile: "default",
    };
