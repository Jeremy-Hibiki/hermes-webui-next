...
describe("FileEditor", () => {
  it("renders textarea with file content", () => {
    render(
      <FileEditor path="src/app.ts" content="export {}" onSave={vi.fn()} />
    );
  ...
  it("shows save button", () => {
    render(
      <FileEditor path="src/app.ts" content="hello" onSave={vi.fn()} />
    );
  ...
  it("calls onSave with new content on save click", () => {
    const onSave = vi.fn();
    render(
      <FileEditor path="src/app.ts" content="original" onSave={onSave} />
    );
