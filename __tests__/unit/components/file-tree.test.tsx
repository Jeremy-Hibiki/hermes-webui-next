...
describe("FileTree", () => {
  it("renders file entries", () => {
    render(
      <FileTree entries={mockEntries} onFileSelect={vi.fn()} onDirToggle={vi.fn()} />
    );
  ...
  it("calls onFileSelect when a file is clicked", () => {
    ...
    render(
      <FileTree entries={mockEntries} onFileSelect={onFileSelect} onDirToggle={vi.fn()} />
    );
  ...
  it("calls onDirToggle when a directory is clicked", () => {
    ...
    render(
      <FileTree entries={mockEntries} onFileSelect={vi.fn()} onDirToggle={onDirToggle} />
    );
  ...
  it("shows empty state when no entries", () => {
    render(
      <FileTree entries={[]} onFileSelect={vi.fn()} onDirToggle={vi.fn()} />
    );
